...
You are familiar with the concepts discussed in  {{< linkWithTitle "concepts/architecture/orgs-tenants.md" >}}.
...
* [Role-based deployment approval]({{< ref "concepts/deployment/role-based-manual-approval.md" >}})
...
After you define your roles, you use the CLI to [add your roles]({{< ref "tasks/iam/create-role" >}}) to your CD-as-a-Service Organization. You do all subsequent role management with the CLI, but you [assign roles to users]({{< ref "tasks/iam/manage-role-user" >}}) using the UI.
...
A Client Credential must also have an RBAC role to access CD-as-a-Service functionality. See {{< linkWithTitle "tasks/iam/client-creds.md" >}} for how to assign a role to a Client Credential.
...
* {{< linkWithTitle "concepts/deployment/role-based-manual-approval.md" >}}
* Tasks: {{< linkWithTitle "tasks/iam/create-role.md" >}}, {{< linkWithTitle "tasks/iam/update-role.md" >}}, {{< linkWithTitle "tasks/iam/delete-role.md" >}}, {{< linkWithTitle "tasks/iam/invite-users.md" >}}, {{< linkWithTitle "tasks/iam/client-creds.md" >}}
* Tutorial: {{< linkWithTitle "tutorials/access-management/rbac-users.md" >}}
