...
You are familiar with the concepts discussed in  {{< linkWithTitle "docs/concepts/architecture/orgs-tenants.md" >}}.
...
* [Role-based deployment approval]({{< ref "docs/concepts/deployment/role-based-manual-approval.md" >}})
...
After you define your roles, you use the CLI to [add your roles]({{< ref "docs/tasks/iam/create-role" >}}) to your CD-as-a-Service Organization. You do all subsequent role management with the CLI, but you [assign roles to users]({{< ref "docs/tasks/iam/manage-role-user" >}}) using the UI.
...
A Client Credential must also have an RBAC role to access CD-as-a-Service functionality. See {{< linkWithTitle "docs/tasks/iam/client-creds.md" >}} for how to assign a role to a Client Credential.
...
* {{< linkWithTitle "docs/concepts/deployment/role-based-manual-approval.md" >}}
* Tasks: {{< linkWithTitle "docs/tasks/iam/create-role.md" >}}, {{< linkWithTitle "docs/tasks/iam/update-role.md" >}}, {{< linkWithTitle "docs/tasks/iam/delete-role.md" >}}, {{< linkWithTitle "docs/tasks/iam/invite-users.md" >}}, {{< linkWithTitle "docs/tasks/iam/client-creds.md" >}}
* Tutorial: {{< linkWithTitle "docs/tutorials/access-management/rbac-users.md" >}}
