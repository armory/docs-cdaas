...
1. {{< linkWithTitle "docs/setup/quickstart.md" >}}
1. {{< linkWithTitle "docs/setup/deploy-your-app.md" >}}
...
3. Complete the wizard:
   ...
   The parameters you need to provide depend on the metrics provider you choose. For more information, see the {{< linkWithTitle "docs/tasks/canary/add-integrations.md" >}} guide.
...
4. Add a **Query Template**. Use the following example:
   ...
   - **Query Template**:
      ...
      - The query contains variables that are automatically injected during canary analysis, but you must manually provide some of them during retrospective analysis.
        - Time related variables like `armory.promqlStepInterval` are automatically substituted by Armory CD-as-a-Service. For a full list, see the {{< linkWithTitle "docs/tasks/canary/retro-analysis.md" >}} guide.
...
* {{< linkWithTitle "docs/tasks/canary/retro-analysis" >}}
* {{< linkWithTitle "docs/reference/ref-queries" >}}