...
* You are familiar with CD-as-a-Service's [key components]({{< ref "docs/concepts/architecture/key-components.md" >}}) and [system requirements]({{< ref "docs/concepts/architecture/system-requirements.md" >}}).
