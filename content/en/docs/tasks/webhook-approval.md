...
You have read the {{< linkWithTitle "docs/concepts/external-automation.md" >}} guide.
...
* [Webhooks section in the deployment file reference]({{< ref "docs/reference/ref-deployment-file#webhooks." >}})
* {{< linkWithTitle "docs/tutorials/external-automation/webhook-github.md" >}}
