...
* You have [installed the `armory` CLI]({{< ref "docs/setup/cli" >}}).
* You have installed [Helm](https://helm.sh/docs/intro/install/).
* You have a GitHub account so you can fork the sample project.
* You have read the {{< linkWithTitle "docs/concepts/iam/rbac.md" >}} content.
* You have completed the  {{< linkWithTitle "docs/tutorials/deploy-sample-app.md" >}}.
