...
* You have completed the Armory CD-as-a-Service [quickstart]({{< ref "docs/setup/quickstart" >}}), in which you create your login credentials, install the CLI, and deploy a sample app.
