...
- Connected to your Kubernetes cluster and deployed an app using the CLI. See {{< linkWithTitle "setup/quickstart.md" >}}.
...
See {{< linkWithTitle "tasks/deploy/create-deploy-config.md" >}} if you want to create a more robust deployment config file. 
The {{< linkWithTitle "reference/ref-deployment-file.md" >}} page contains explanations of the fields.
...
* {{< linkWithTitle "concepts/external-automation.md" >}}
