...
1. {{< linkWithTitle "setup/quickstart.md" >}}
1. {{< linkWithTitle "setup/deploy-your-app.md" >}}
...
3. Complete the wizard:
   ...
   The parameters you need to provide depend on the metrics provider you choose. For more information, see the {{< linkWithTitle "tasks/canary/add-integrations.md" >}} guide.
...
4. Add a **Query Template**. Use the following example:
   ...
   - **Query Template**:
      ...
      - The query contains variables that are automatically injected during canary analysis, but you must manually provide some of them during retrospective analysis.
        - Time related variables like `armory.promqlStepInterval` are automatically substituted by Armory CD-as-a-Service. For a full list, see the {{< linkWithTitle "tasks/canary/retro-analysis.md" >}} guide.
...
* {{< linkWithTitle "tasks/canary/retro-analysis" >}}
* {{< linkWithTitle "reference/ref-queries" >}}