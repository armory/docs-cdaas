...
* You are familiar with CD-as-a-Service's [key components]({{< ref "concepts/architecture/key-components.md" >}}).
...
- Manual Approvals
- Timed Pauses
- [Webhooks]({{< ref "tasks/webhook-approval" >}})
- [Automated Canary Analysis]({{< ref "setup/canary" >}})
...
CD-as-a-Service integrates with service meshes like [Istio]({{< ref "tasks/deploy/traffic-management/istio" >}}) and [Linkerd]({{< ref "tasks/deploy/traffic-management/linkerd" >}}), but you do not need to use a service mesh to use a CD-as-a-Service `canary` strategy.

CD-as-a-Service also supports a [blue/green]({{< ref "setup/blue-green" >}}) deployment strategy.
...
* {{< linkWithTitle "setup/deploy-your-app.md" >}}
* {{< linkWithTitle "setup/gh-action.md" >}}
* {{< linkWithTitle "setup/blue-green.md" >}}
* {{< linkWithTitle "setup/canary.md" >}}
* {{< linkWithTitle "setup/argo-rollouts.md" >}}