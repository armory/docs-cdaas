---
title: Canary Deployment With Retrospective Analysis Tutorial
linkTitle: Retrospective Analysis
description: >
  Learn how to configure a canary deployment strategy that uses retrospective analysis. Integrate your metrics provider, create a retrospective analysis query, and add canary analysis as a deployment constraint. Deploy your app to your Kubernetes cluster using Armory CD-as-a-Service.
categories: ["Deployment", "Tutorials"]
tags: ["Deploy Strategy", "Retrospective Analysis", "Kubernetes"]
draft: true
---

@TODO turn this into a proper tutorial, like the blue/green one
